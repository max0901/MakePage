    ...
    <>
      <div id="container">
            ...
            <div class="rost_list">
              <ul>
                ...
                <li>
                  ...
                  <p>
                    누구나 맛있게 먹을 수 있는 커피를 고민하다 만든 블렌딩
                    입니다. 고소함과 구수함이 오래 전 잊고 있던 편안함을 느끼게
                    해줍니다. 중강배전 포인트로 우유와도 잘 어울립니다.
                  </p>
                  <a>
                    <img src="../img/cart.png" alt="" />
                    <p>Cart</p>
                ...
                <li>
                  ...
                  <p>
                    ...
                    바디감과 다크초콜릿의 단맛이 큰 특징이며 깊고 진한 여운은
                    많은 분들에게 사랑받는 큰 이유입니다.
                  </p>
                  <a href="">
                    <img src="../img/cart.png" alt="" />
                    <p>Cart</p>
                ...
                <li>
                  ...
                  <p>
                    스페셜티커피의 열풍이 불면서 산미에 초점이 맞춰진
                    현실입니다. 그동안 우리의 기억속에 잊혀진 기존 원두의 풍미를
                    기억하고자 블랙프로젝트를 기획했습니다. 모든 분들에게
                    단맛계열의 플레이버가 가득한 커피를 전해드리겠습니다.
                  </p>
                  <a href="">
                    <img src="../img/cart.png" alt="" />
                    <p>Cart</p>
        ...
        <section id="insta">
          <div id="insta_inner">
            ...
            <div id="img_inner">
              ...
              <input type="button" value="더보기" id="button" class="button" />
            </div>
          </div>
        </section>
        <section id="faq">
          ...
          <div id="faq_inner">
            <ul>
              <li>
                ...
                <p>카카오플러스친구 : 로컬커피로스터스</p>
              </li>
              <li>
                <a href="">
                  <img src="../img/faqA.png" alt="" />
                </a>
                <h2>원두 대량구매 문의</h2>
                <p>(5kg 이상) 010-2222-3333</p>
              </li>
              <li>
                <a href="">
                  <img src="../img/bulbA.png" alt="" />
                </a>
                <h2>로컬커피로스터스</h2>
                <p>파트너 안내 커피원두도매, 납품부터 교육까지</p>
                <input
                  type="button"
                  value="바로가기"
                  id="button"
        ...
        <section id="outro">
          <hr />
          <div id="outro_inner">
            <h2>LOCAL COFFEE ROASTERS</h2>
            <p class="middle">A cup of excellence for you</p>
            <p>
              " 그 &nbsp;&nbsp;한 &nbsp;잔 을 &nbsp;위 해 &nbsp;노 력 합 니 다 "
            </p>
          </div>
        </section>
        <section id="real_btn">
